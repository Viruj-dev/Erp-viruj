...
export function HealthcareLaunchIllustration() {
  return (
    <div className="relative mx-auto h-48 max-w-[280px]">
      ...
      <div className="absolute bottom-8 left-1/2 h-28 w-32 -translate-x-1/2 rounded-[26px] bg-white text-[#062d4f] shadow-2xl">
      ...
      <div className="absolute left-2 top-8 flex size-14 items-center justify-center rounded-2xl bg-cyan-200 text-[#062d4f] shadow-xl">
        <Sun size={24} />
      </div>
