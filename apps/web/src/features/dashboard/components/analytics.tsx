    ...
    <div className="space-y-6 p-6 lg:p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        <Panel
          ...
          description="Revenue and expense movement ported from the demo dataset."
        ...
        <Panel
          ...
          description="Distribution of activity across specialties."
          eyebrow="Department distribution"
          title="Clinical mix"
        >
        ...
        <Panel
          ...
          description="Age-band counts from the ERP-demo mock data."
          eyebrow="Patient demographics"
          title="Population profile"
        >
          <MiniBarChart
            data={patientDemographics.map((item) => ({
              name: item.age,
              value: item.count,
            }))}
          />
        ...
        <Panel
          className="lg:col-span-6"
          description="Operational recommendations preserved from the demo UI."
          eyebrow="AI-driven insights"
          title="Priority opportunities"
        >
          <div className="space-y-4">
            <InsightCard
              body="Cardiology billing cycles are 15% slower than average. Automated coding could recover roughly $12k monthly."
              title="Revenue growth opportunity"
            />
            <InsightCard
              body="Patient follow-up rate dropped 4% in Pediatrics. Trigger reminder outreach before next week."
              title="Patient retention alert"
            />
            <InsightCard
              body="Lab utilization peaks between 10 AM and 12 PM. Shift non-urgent appointments to afternoon slots."
